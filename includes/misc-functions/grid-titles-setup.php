...
function mp_stacks_sermongrid_title_animation_js( $existing_filter_output, $post_id, $meta_prefix ){
	...
	$title_animation_js = mp_core_js_mouse_over_animate_child( '#mp-brick-' . $post_id . ' .mp-stacks-grid-item', '.mp-stacks-sermongrid-item-title-holder', mp_core_get_post_meta( $post_id, 'sermongrid_title_animation_keyframes', array() ) ); 
