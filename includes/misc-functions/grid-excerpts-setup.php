...
/**
 * Add the meta options for the Grid Excerpts to the SermonGrid Metabox
 *
 * @access   public
 * @since    1.0.0
 * @param    Void
...
function mp_stacks_sermongrid_excerpt_meta_options( $items_array ){
	...
	$new_fields = array(
		//Excerpt
		'sermongrid_excerpt_showhider' => array(
			'field_id'			=> 'sermongrid_excerpt_settings',
			'field_title' 	=> __( 'Excerpt Settings', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( '', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'showhider',
			'field_value' => '',
		),
		'sermongrid_excerpt_show' => array(
			'field_id'			=> 'sermongrid_excerpt_show',
			'field_title' 	=> __( 'Show Excerpts?', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Do you want to show the Excerpts for these posts?', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'checkbox',
			'field_value' => 'true',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_placement' => array(
			'field_id'			=> 'sermongrid_excerpt_placement',
			'field_title' 	=> __( 'Excerpt Placement', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Where would you like to place the excerpt? Default: Below Image, Left', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'select',
			'field_value' => '',
			'field_select_values' => mp_stacks_get_text_position_options(),
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_color' => array(
			'field_id'			=> 'sermongrid_excerpt_color',
			'field_title' 	=> __( 'Excerpt Color', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Select the color the excerpts will be (leave blank for theme default)', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'colorpicker',
			'field_value' => '',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_size' => array(
			'field_id'			=> 'sermongrid_excerpt_size',
			'field_title' 	=> __( 'Excerpt Size', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Enter the text size the excerpts will be. Default: 15', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'number',
			'field_value' => '15',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_lineheight' => array(
			'field_id'			=> 'sermongrid_excerpt_lineheight',
			'field_title' 	=> __( 'Excerpt Line Height', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Enter the line height for the excerpt text. Default: 19', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'number',
			'field_value' => '19',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		...
		'sermongrid_excerpt_google_font_weight_style' => array(
			'field_id'			=> 'sermongrid_excerpt_google_font_weight_style',
		...
		'sermongrid_excerpt_spacing' => array(
			...
			'field_description' 	=> __( 'How much space should there be between the excerpt and any content directly above it? Default: 10', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'number',
			'field_value' => '10',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_word_limit' => array(
			'field_id'			=> 'sermongrid_excerpt_word_limit',
			'field_title' 	=> __( 'Word Limit for Excerpt', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'How many words should be displayed before the "Read More" link is shown. Default: All words are shown.', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'number',
			'field_value' => '',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		//Excerpt animation stuff
		'sermongrid_excerpt_animation_desc' => array(
			'field_id'			=> 'sermongrid_excerpt_animation_description',
			'field_title' 	=> __( 'Animate the Excerpt upon Mouse-Over', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Add keyframe animations to apply to the excerpt and play upon mouse-over.', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'basictext',
			'field_value' => '',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_animation_repeater_title' => array(
			'field_id'			=> 'sermongrid_excerpt_animation_repeater_title',
			'field_title' 	=> __( 'KeyFrame', 'mp_stacks_sermongrid'),
			'field_description' 	=> NULL,
			'field_type' 	=> 'repeatertitle',
			'field_repeater' => 'sermongrid_excerpt_animation_keyframes',
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		'sermongrid_excerpt_animation_length' => array(
		...
		'sermongrid_excerpt_animation_opacity' => array(
			'field_id'			=> 'opacity',
		...
		'sermongrid_excerpt_animation_rotation' => array(
			'field_id'			=> 'rotateZ',
		...
		'sermongrid_excerpt_animation_x' => array(
			'field_id'			=> 'translateX',
		...
		'sermongrid_excerpt_animation_y' => array(
			'field_id'			=> 'translateY',
		...
		'sermongrid_excerpt_read_more_text' => array(
			'field_id'			=> 'sermongrid_excerpt_read_more_text',
			'field_title' 	=> __( '"Read More" Text for Excerpt\'s', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'What should the "Read More" text be at the end of the Excerpt? Default: "[Read More]". For no output type "*****" (5 asterisks).', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'textbox',
			'field_value' => __( '[Read More]', 'mp_stacks_sermongrid' ),
			'field_showhider' => 'sermongrid_excerpt_settings',
		),
		//Excerpt Background
		'sermongrid_excerpt_bg_showhider' => array(
			'field_id'			=> 'sermongrid_excerpt_background_settings',
			'field_title' 	=> __( 'Excerpt Background Settings', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( '', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'showhider',
			'field_value' => '',
		),
		'sermongrid_excerpt_bg_show' => array(
			'field_id'			=> 'sermongrid_excerpt_background_show',
			'field_title' 	=> __( 'Show Excerpt Backgrounds?', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'Do you want to show a background color behind the excerpt?', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'checkbox',
			'field_value' => '',
			'field_showhider' => 'sermongrid_excerpt_background_settings',
		),
		'sermongrid_excerpt_bg_size' => array(
			'field_id'			=> 'sermongrid_excerpt_background_padding',
			'field_title' 	=> __( 'Excerpt Background Size', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'How many pixels bigger should the Excerpt Background be than the Text? Default: 5', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'number',
			'field_value' => '5',
			'field_showhider' => 'sermongrid_excerpt_background_settings',
		),
		'sermongrid_excerpt_bg_color' => array(
			'field_id'			=> 'sermongrid_excerpt_background_color',
			'field_title' 	=> __( 'Excerpt Background Color', 'mp_stacks_sermongrid'),
			'field_description' 	=> __( 'What color should the excerpt background be? Default: #FFF (White)', 'mp_stacks_sermongrid' ),
			'field_type' 	=> 'colorpicker',
			'field_value' => '#FFF',
			'field_showhider' => 'sermongrid_excerpt_background_settings',
		),
		'sermongrid_excerpt_bg_opacity' => array(
			'field_id'			=> 'sermongrid_excerpt_background_opacity',
			'field_title' 	=> __( 'Excerpt Background Opacity', 'mp_stacks_sermongrid'),
...
add_filter( 'mp_stacks_sermongrid_items_array', 'mp_stacks_sermongrid_excerpt_meta_options', 11 );
...
/**
 * Add the JS for the excerpt to SermonGrid's HTML output
 *
 * @access   public
 * @since    1.0.0
...
function mp_stacks_sermongrid_excerpt_css( $css_output, $post_id ){
	...
	return $css_output .= mp_stacks_grid_text_css( $post_id, 'sermongrid_excerpt', 'mp-stacks-sermongrid-item-excerpt', $excerpt_css_defaults );
}
add_filter('mp_stacks_sermongrid_css', 'mp_stacks_sermongrid_excerpt_css', 10, 2);

/**
 * Add the Google Fonts for the Grid Excerpt
 *
